...
public class MgSetFieldToVariableInstruction extends MgSequentialInstruction {
    @Value
    ...
    public MgSetFieldToVariableInstruction(int sourceIndex, int sourceFieldIndex, int targetIndex) {
