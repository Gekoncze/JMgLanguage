...
public class MgIntMultiplyInstruction extends MgBuildinInstruction {
    @Value
    ...
    public MgIntMultiplyInstruction(int sourceLeftIndex, int sourceRightIndex, int targetIndex) {
