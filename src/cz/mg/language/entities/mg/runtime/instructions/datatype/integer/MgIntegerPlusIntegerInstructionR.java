...
public class MgIntegerPlusIntegerInstructionR extends MgDatatypeInstructionR {
    @Value
    ...
    public MgIntegerPlusIntegerInstructionR(int sourceLeftIndex, int sourceRightIndex, int targetIndex) {
