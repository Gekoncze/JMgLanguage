...
//
//
//public class MgFloatMinusInstruction extends MgBuildinInstruction {
//    @Value
...
//
//    public MgFloatMinusInstruction(int sourceLeftIndex, int sourceRightIndex, int targetIndex) {
