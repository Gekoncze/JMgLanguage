...
//
//
//public class MgFloatDivideInstruction extends MgBuildinInstruction {
//    @Value
...
//
//    public MgFloatDivideInstruction(int sourceLeftIndex, int sourceRightIndex, int targetIndex) {
